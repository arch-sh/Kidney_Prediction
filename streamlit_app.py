# import streamlit, joblib, shap as st
# import pandas as pd
# import joblib
...
# @st.cache_data
# def load_model():
#     with open('kidney_shap_explainer', 'rb') as file:
...
def load_model_and_explainer():
    model = joblib.load("kidney_disease_model.pkl")  # trained model
    explainer = joblib.load("kidney_shap_explainer.pkl")  # SHAP explainer
    return model, explainer

loaded_model, explainer = load_model_and_explainer()
...
if options == 'Prediction':
    ...
    if st.button('Predict'):
        ...
        # -----------------------------
        st.markdown("---")
        st.markdown("### 🔍 Why this prediction? (Using Explainable AI)")
